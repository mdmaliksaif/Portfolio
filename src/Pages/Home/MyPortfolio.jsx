...
export default function MyPortfolio() {
  return (
    ...
    <a href="https://github.com/mdmaliksaif" target="_blank" rel="noopener noreferrer" class="btn btn-github ws">
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src={item.src} alt="Placeholder" className="portfolio-image"/>
            </div>
